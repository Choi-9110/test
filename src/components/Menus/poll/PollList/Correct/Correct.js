                        ...
                        <section id="bo_write">
                            <div className="bo_left">
                                ...
                                <div className="item">
                                    ...
                                    <div className="desc">
                                        <div className="boxs">
                                            <input className="ex-box" type="text" onChange={handleSelect_Text_1} value={Select_1 || qdata.Select_1} placeholder="보기를 입력해주세요." />
                            ...
                            <div className="right preview">
                                ...
                                <div className="phone">
                                    <div className="desc">
                                        <div>{Title || qdata.Title}</div>
                                        <div>{Image || qdata.Image}</div>
                                        <div>{Select_Image_1 || qdata.Select_Image_1}
                                            {Select_Image_1 || qdata.Select_Image_2}</div>
                                        <div>{Select_1 || qdata.Select_1} {Select_2 || qdata.Select_2}</div>
                                        <div>{Rewards || qdata.Rewards}<br/>{Max_Personnel || qdata.Max_Personnel}</div>
                                    </div>
                                </div>
                            </div>
                        </section>
                        <section id="bo_btn-wrap">
                            <form className="bo_registration-btn"><a>수정</a></form>
                        </section>
                    </div>
                ))}
            </div>
