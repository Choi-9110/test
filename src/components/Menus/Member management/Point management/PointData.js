			...
			<section id="point_list">
				...
				<table>
					...
					{pointList.map((pdata, Point_Idx)=>(
							...
							<td className="state">{pdata.Submit_Date} 여기날짜만 남겨줘여 </td>
							<td className="state">{pdata.Submit_Date} 여기 시간만남겨줘여</td>
							<td className="state"><span className="state ongoing">{pdata.Point_State}</span></td>
